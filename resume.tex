...
\cvitem{\textbf{Web \& DB}}{HTML5, CSS/Sass, React/Redux, Angular, SQL (Postgres), MongoDB, Redis, RabbitMQ, RxJS}
\cvitem{\textbf{Cloud}}{Kubernetes, OpenShift, Docker, IBM Cloud}
\cvitem{\textbf{Misc.}}{Git, Linux, Argo CI/CD, Agile, Jira, Jenkins, Trello, Cypress, ZenHub, GitOps, \LaTeX{}}
